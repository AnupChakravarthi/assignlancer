...
if(!isset($_SESSION["HWG_ACCOUNT_ID"])){
 ?>
...
<?php } else { 
      if($_SESSION["HWG_ACCOUNT_TYPE"]=='CUSTOMERS') { header("Location:".$_SESSION["HWG_PROJECT_URL"].'app/students/dashboard'); } 
 else if($_SESSION["HWG_ACCOUNT_TYPE"]=='CUSTOMER_LIVESUPPORT') { header("Location:".$_SESSION["HWG_PROJECT_URL"].'app/liveSupport/dashboard'); } 
 else if($_SESSION["HWG_ACCOUNT_TYPE"]=='ADMINISTRATOR') { header("Location:".$_SESSION["HWG_PROJECT_URL"].'app/admin/dashboard'); } 
} ?>